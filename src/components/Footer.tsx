...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#022c22] text-white border-t border-emerald-900/60 pt-16 pb-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-emerald-800/60">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-800 border border-emerald-500/40 flex items-center justify-center text-[#86efac]">
                <Sparkles className="w-5 h-5" />
              </div>
              <div className="flex flex-col">
                <span className="font-black text-xl tracking-tight text-white">
                  HACKATHON<span className="text-[#22c55e]">.SMK</span>
                </span>
            ...
            <div className="pt-2 flex items-center gap-3">
              <span className="px-3 py-1 rounded-full bg-emerald-900/80 border border-emerald-700/50 text-[10px] font-mono text-[#86efac]">
                PROGRAM RESMI VOKASI 2026
              </span>
              <span className="px-3 py-1 rounded-full bg-emerald-900/80 border border-emerald-700/50 text-[10px] font-mono text-emerald-300">
                KEMENDIKDASMEN RI
              </span>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="font-mono text-xs font-bold text-[#86efac] uppercase tracking-wider">
              NAVIGASI UTAMA
            </h4>
            <ul className="space-y-2 text-xs text-slate-300">
              ...
              <li><a href="#hadiah" className="hover:text-white transition-colors">Total Hadiah & Benefit</a></li>
